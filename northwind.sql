...
ALTER TABLE ONLY ORDER_DETAILS
  ADD CONSTRAINT PK_ORDER_DETAILS PRIMARY KEY (
    ORDER_ID,
    PRODUCT_ID
  );
...
ALTER TABLE ONLY SHIPPERS
  ADD CONSTRAINT PK_SHIPPERS PRIMARY KEY (
    SHIPPER_ID
  );
...
ALTER TABLE ONLY US_STATES
  ADD CONSTRAINT PK_USSTATES PRIMARY KEY (
    STATE_ID
  );
...
ALTER TABLE ONLY CUSTOMER_CUSTOMER_DEMO
  ADD CONSTRAINT FK_CUSTOMER_CUSTOMER_DEMO_CUSTOMER_DEMOGRAPHICS FOREIGN KEY (
    CUSTOMER_TYPE_ID
  )
